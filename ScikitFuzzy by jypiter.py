'''
Fuzzy Logic in SciKit-Fuzzy 
http://nbviewer.jupyter.org/github/WeatherGod/scipy2013_talks/blob/master/talks/joshua_warner/scikit-fuzzy_demo.ipynb
'''
...
# Membership functions for heat， trimf = triangular membership function
...
ax.set_ylim(-0.05, 1.05)  # specifies limit of the y-axis
